                                ...
                                <form role="form" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="comment">請輸入想查詢的注音或漢語拼音 (例如:ㄨㄛˇ 或 wǒ):</label>
                                            <input type="text" class="form-control" name="search_character" maxlength="3" placeholder="字音或漢語拼音..." style="width: 140px">
                                        </div>
                                        <div class="form-group">
                                            <label>
